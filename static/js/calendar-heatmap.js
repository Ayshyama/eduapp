  ...
  drawYearOverview: function() {
    ...
    calendarHeatmap.items.selectAll('.item-circle')
      ...
      .on('mouseover', function(d) {
        ...
        // Construct tooltip
        var tooltip_html = '';
        tooltip_html += '<div class="header"><strong>' + (d.total ? calendarHeatmap.formatTime(d.total) : 'No time') + ' aassdsatracked</strong></div>';
        ...
        // Calculate tooltip position
        var x = calcItemX(d) + calendarHeatmap.settings.item_size * 20;
